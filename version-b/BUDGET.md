# Budget estimate — Garda ↔ Iseo corridor (1 – 7 Sep 2026)

All figures in **EUR (€)**. **5 people, tent(s) + car**, **7 days / 6 camping nights** (see [PLAN.md](PLAN.md)).

Car hire detail: [../version-a/BUDGET.md § Car hire](../version-a/BUDGET.md#1-car-hire--bergamo-bgy--local-alternatives).

> **Last updated:** June 2026. Re-check booking sites before paying.
...
## 2. Camping (6 nights, 2 sites)

| Camp | Nights | Low | High | Book |
|------|--------|-----|------|------|
| Camping del Sole, Iseo | 2 | €100 | €160 | [campingdelsole.it](https://www.campingdelsole.it/en/) |
| Camping Brione, Riva | 4 | €220 | €340 | [campingbrione.com](https://www.campingbrione.com/EN/) |
| **Subtotal** | **6** | **€320** | **€500** | |

**5 people:** confirm **large pitch** or two adjacent pitches; Brione and del Sole are busiest — book early for **3–6 Sep** (Brione) and **1–2 Sep** (del Sole).
...
| Item | Low | High |
|------|-----|------|
| Fuel (~320 km + local day trips) | €55 | €90 |
...
| Category | Low | High |
|----------|-----|------|
| Car hire (14 days) | €380 | €780 |
| Camping (12 nights) | €670 | €1,020 |
| Activities (both plans) | €215 | €535 |
| Food & fuel (14 days) | €875 | €1,580 |
