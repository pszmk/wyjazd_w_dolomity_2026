...
| **Driving** | **≤100 km/day** — Iseo→Riva split over two days (~55 + ~50 km); direct return to BGY |
...
Shared packing list: [../version-a/EQUIPMENT.md](../version-a/EQUIPMENT.md) (standard hiking kit + ferrata gloves for Day 5).
...
| Main hike at Iseo | Lakeshore | **Monte Guglielmo** | Staging only |
| Ferrata | Optional appendix | **Colodri (main plan)** | Gran Cir, Ra Gusela |
| Food tips | — | **Camp kitchen + restaurants** | — |
| Budget (excl. flights) | ~€980–1,790 | **~€997–1,837** | ~€1,525–2,575 |
